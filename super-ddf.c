				 ...
				 int consistency_policy, int verbose)
{
	...
	if (is_container(level)) {
		...
		return validate_geometry_ddf_container(st, level, raiddisks, data_offset,
	...
	if (st->sb) {
		 ...
		 */
		return validate_geometry_ddf_bvd(st, level, layout, raiddisks, chunk, size,
						 data_offset, dev, freesize, verbose);
	}
