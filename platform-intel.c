 ...
 * IMSM must know VMD domains, therefore it needs to determine anf follow buses.
 *
 */
mdadm_status_t vmd_find_pci_bus(char *vmd_path, char *buf)
{
	 ...
	 * not exist yet.
	 *
	 * In that case, we have to look into directory. This is secondary way to prevent boot
	 * issues.
	 */
